                    ...
                    <div class="col-lg-3">
                        <div class="gallery-item">
                            <div class="card" style="">
                                <img class="card-img-top" src="{{ asset('uploads/player/'.$player->image) }}" alt="default.png" style="padding-top: 15px; padding-right: 15px;">
                                <div class="card-body">
                                    <h5 class="card-title">{{ $player->name }}</h5>
                                    <p class="card-text">{{ $player->brief_note }}</p>
                                    <a href="{{ route('PlayerDetails',$player->id) }}" class="btn btn-primary">বিস্তারিত</a>
                                </div>
                            </div>
                        </div>
                    </div>
