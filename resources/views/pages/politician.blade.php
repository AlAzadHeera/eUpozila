                    ...
                    <div class="col-lg-3">
                        <div class="gallery-item">
                            <div class="card" style="">
                                <img class="card-img-top" src="{{ asset('uploads/politician/'.$politician->image) }}" alt="default.png" style="padding-top: 15px; padding-right: 15px;">
                                <div class="card-body">
                                    <h5 class="card-title">{{ $politician->name }}</h5>
                                    <p class="card-text">{{ $politician->brief_note }}</p>
