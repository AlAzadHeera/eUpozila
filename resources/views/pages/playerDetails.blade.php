                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="pg-portfolio-images cr-slider-navigation">
                            <a href="{{ asset('uploads/player/'.$player->image) }}">
                                <img class="img-responsive" style="height: 500px;" src="{{ asset('uploads/player/'.$player->image) }}" alt="single-image">
                            </a>
                        </div>
                        <div class="pg-portfolio-details">
                            <div class="section-title text-center">
                                <h2>{{ $player->brief_note }}</h2>
