                                            ...
                                            <form action="{{ route('admin.actor.update',$actor->id) }}" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <input name="name" type="text" class="form-control" value="{{ $actor->name }}" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <input name="brief_note" type="text" class="form-control" value="{{ $actor->brief_note }}" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <textarea name="description" id="summernote1" cols="30" rows="10">{{ $actor->description }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9" data-date-format="dd.mm.yyyy">
                                                            <input type="text" name="birthday" class="form-control input-group date" value="{{ $actor->birthday }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9" data-date-format="dd.mm.yyyy">
                                                            <input type="text" name="deathday" class="form-control input-group date" value="{{ $actor->deathday }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <img style="width: 250px; float: left;" src="{{ asset('uploads/actor/'.$actor->image) }}" alt="default.png">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
