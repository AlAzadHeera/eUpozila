                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="all-form-element-inner">
                                            <form action="{{ route('admin.player.update',$player->id) }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                @method('put')
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <input name="name" type="text" class="form-control" value="{{ $player->name }}" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <input name="brief_note" type="text" class="form-control" value="{{ $player->brief_note }}" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <textarea name="description" id="summernote1" cols="30" rows="10">{{ $player->description }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9" data-date-format="dd.mm.yyyy">
                                                            <input type="text" name="birthday" class="form-control input-group date" value="{{ $player->birthday }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9" data-date-format="dd.mm.yyyy">
                                                            <input type="text" name="deathday" class="form-control input-group date" value="{{ $player->deathday }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <img style="width: 250px; float: left;" src="{{ asset('uploads/player/'.$player->image) }}" alt="default.png">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
